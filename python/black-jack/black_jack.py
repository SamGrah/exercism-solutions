...
FACE_CARDS = {'K', 'Q', 'J'}
ACE_CARD = 'A'
NUMBER_CARDS = {str(num) for num in range(1, 11)}
...
def value_of_ace(card_one, card_two):
    ...
    return 11 if value_of_hand <= 10 else 1
...
def is_blackjack(card_one, card_two):
    ...
    has_high_value_card = 10 in (card_one_value, card_two_value)
    contains_ace = ACE_CARD in (card_one, card_two)

    return has_high_value_card and contains_ace

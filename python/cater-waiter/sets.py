...
def check_drinks(drink_name, drink_ingredients):
    ...
    is_alcoholic = not set(drink_ingredients).isdisjoint(ALCOHOLS)
    return f'{drink_name} {"C" if is_alcoholic else "M"}ocktail'
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category_name in categories:
        ingredients = categories[category_name]
...
def singleton_ingredients(dishes, intersection):
    ...
    master_ingredients = compile_ingredients(dishes)
    return master_ingredients.difference(intersection)
